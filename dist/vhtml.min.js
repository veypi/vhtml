...
const moduleContextManager = new ModuleContextManager();function CamelToKebabCase(str) {
...
const utils = { CamelToKebabCase, EventsList, BindInputDomValue, SetAttr, AddClicker };/*
...
async function parseRef(vsrc, dom, data, runtime, target, optsOrCtx, ctx) {
  ...
  mountRef(dom, originData, componentRuntime, target);
